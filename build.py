...
SOURCES = ['main.cpp', 'strings.cpp', 'util.cpp', 'sysinfo.cpp',
           'tweaks.cpp', 'games.cpp', 'ui.cpp', 'power.cpp', 'net.cpp', 'watch.cpp']
LIBS = ['comctl32', 'gdi32', 'gdiplus', 'shell32', 'ole32', 'uuid',
        'powrprof', 'advapi32', 'comdlg32', 'winhttp', 'iphlpapi']
...
def main():
    ...
    run([sys.executable, 'tools/inject_resources.py', raw, full,
         ...
         '--db', 'data/games_db.json', '--ver', '1.2.0'])
    ...
    zpath = os.path.join(RELEASE, 'FPSBooster-v1.2-Portable.zip')
