...
{SID_VER, "Version 2.1.0", "نسخه 2.1.0"},
...
{SID_SET_ABOUT, "FPS Booster Pro 2.1.0 - Ultimate Game FPS Optimizer", "FPS Booster Pro نسخه 2.1.0 - بهینه‌ساز نهایی اف‌پی‌اس بازی"},
