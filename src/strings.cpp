...
{SID_VER, "Version 1.4.0", "نسخه 1.4.0"},
...
{SID_SET_ABOUT, "FPS Booster Pro 1.4.0 - Ultimate Game FPS Optimizer", "FPS Booster Pro نسخه 1.4.0 - بهینه‌ساز نهایی اف‌پی‌اس بازی"},
